...
Compilers are programs that transform code in a programming language to another language (low lever or machine code)
...
- It alsos polyfill GraphQL to enable fragments to have arguments, this provides a better DX without losing performance
